...
class Economy:
    ...
    async def register(self, ctx):
        """Registers an account at the Rikyako bank"""
        ...
        try:
            ...
            await self.bot.say("{} You already have an account at the"
                               " Rikyako bank.".format(author.mention))
        ...
        if not user:
            ...
            try:
                ...
                await self.bot.say("{} You don't have an account at the"
                                   " Rikyako bank. Type `{}bank register`"
    ...
    async def _set(self, ctx, user: discord.Member, credits: SetParser):
        ...
        Examples:
            bank set @Rikyako 26 - Sets 26 credits
            bank set @Rikyako +2 - Adds 2 credits
            bank set @Rikyako -6 - Removes 6 credits"""
        author = ctx.message.author
        try:
